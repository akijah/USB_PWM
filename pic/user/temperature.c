...
// This function is used when a real temp sensor is not available.
// It updates tempString with hardcoded data for demo purposes.
void UpdateCelsiusASCII(void)
{
    tempString[0] = '+';
    tempString[1] = ' ';
    ...
    tempString[3] = '5';
    tempString[4]='.';
    // Simulate a slight change in temperature reading
    if(tempString[5] == '1')
    {
        tempString[5] = '2';
    }
